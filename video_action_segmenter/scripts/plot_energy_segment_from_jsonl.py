...
用法示例：
  python -m video_action_segmenter.scripts.plot_energy_segment_from_jsonl \
    --jsonl /media/johnny/Data/data_motion_tokenizer/online_inference_results_codebook2048_stride16/D01_20250810001400/stream_energy_quantized_token_diff_l2_mean.jsonl \
